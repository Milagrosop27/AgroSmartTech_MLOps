...
const Overview = ({ parcelas = [], manejarAprobacionAlerta }) => {
  ...
  const parcelasEnAlerta = datos.filter(p => p.crop_disease_status === 'Mild' || p.crop_disease_status === 'Severe').length;
  ...
  const mildCount = datos.filter((p) => p.crop_disease_status === 'Mild' || p.crop_disease_status === 'Moderate').length;
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">de {datos.length} totales</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
        ...
        <div className="lg:col-span-5 bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-400">Temperatura y humedad superpuestas</p>
          </div>
          {telemetria.length > 0 ? (
            <div className="h-80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            return (
              <div className="space-y-3 max-h-[420px] overflow-y-auto pr-2">
                {emergencias.map((e, idx) => {
                  const color =
                    e.crop_disease_status === 'Severe'
                      ? 'bg-red-600'
                      : e.crop_disease_status === 'Moderate'
                        ? 'bg-amber-500'
                        : 'bg-yellow-500';
        ...
        {/* ESTADO DE SECTORES - GRÁFICO DONA */}
